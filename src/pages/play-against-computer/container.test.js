...
describe('mapDispatchToProps', () => {
  ...
  it('check if scoreForPlayerX function dispatches actions to increase score & games played', () => {
    ...
    expect(dispatch.mock.calls[1][0].type).toEqual('SET_X_SCORE');
    expect(dispatch.mock.calls[2][0].type).toEqual('GAMES_PLAYED');
  });
  ...
  it('check if scoreForPlayerO function dispatches actions to increase score & games played', () => {
    ...
    expect(dispatch.mock.calls[3][0].type).toEqual('SET_O_SCORE');
    expect(dispatch.mock.calls[4][0].type).toEqual('GAMES_PLAYED');
  });
  ...
  it('check if scoreForDraw function dispatches actions to increase score & games played', () => {
    ...
    expect(dispatch.mock.calls[5][0].type).toEqual('SET_DRAW_SCORE');
